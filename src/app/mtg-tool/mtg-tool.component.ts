...
import { Card, CardListResponse, ProcessedSet, Set, SetListResponse } from 'src/app/shared/models';
import { CardTable } from 'src/app/shared/models/card-table.model';
import { CardFilteringService, DialogService } from 'src/app/shared/services';

@Component({
  selector: 'app-mtg-tool',
  templateUrl: './mtg-tool.component.html',
  styleUrls: ['./mtg-tool.component.scss']
})
export class MtgToolComponent implements OnInit {
